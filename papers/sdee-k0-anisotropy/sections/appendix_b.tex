...
\begin{align}
\frac{dr}{dt} &= \frac{K_z-K_{12}}{K_{11}\,K_z}\,\frac{\Delta\sigma_{dif,r}^{\prime}}{\Delta t} - \frac{K_{12}}{K_{11}\,K_z}\,\frac{\Delta\sigma_{dif,z}^{\prime}}{\Delta t}, \label{eq:dr_general}\\[6pt]
\frac{dH}{dt} &= \frac{1}{K_z}\,\frac{\Delta\sigma_{dif,r}^{\prime}}{\Delta t} + \frac{1}{K_z}\,\frac{\Delta\sigma_{dif,z}^{\prime}}{\Delta t}. \label{eq:dH_general}
\end{align}
