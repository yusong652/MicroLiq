...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    Inner pressure &
    $\displaystyle p_i = \Sigma\sqrt{{f_{pw_x}^{i}}^2+{f_{pw_y}^{i}}^2}$ &
    --- \\[12pt]
    Outer pressure &
    $\displaystyle p_o = \Sigma\sqrt{{f_{pw_x}^{o}}^2+{f_{pw_y}^{o}}^2}$ &
    --- \\[12pt]
    Circumferential &
    ...
    Shear &
    $\displaystyle\tau_{z\theta} = \frac{3M_T}{2\pi(R^3-r^3)}$ &
