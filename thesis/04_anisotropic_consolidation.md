...
Figure 3.14 shows the evolution of $Z_{m}$ under different initial $K_{0}$ states during cyclic shear. The initial mechanical coordination number $Z_{m0}$ varies with stress anisotropy: the isotropically consolidated specimen ($K_0$=1.0) exhibits the highest $Z_{m0}$ of approximately 5.0, while the anisotropically consolidated specimens ($K_0$=0.5 and $K_0$=2.0) show lower values around 4.9. This difference in $Z_{m0}$ provides a microscopic explanation for the higher initial shear stiffness observed in the $K_0$=1.0 specimen (Fig. 3.13): more interparticle contacts result in a stiffer fabric structure.
