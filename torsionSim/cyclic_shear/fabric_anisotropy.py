...
ax1.set_ylabel(r'$Fabric\ anisotropy\ indicator\ \alpha$', fontsize=13)
...
plt.annotate(r"$CSR=0.200$", xy=(0.2, 0.10), fontsize=13)

# inset axes settings
ax2.set_ylabel(r'$\alpha_{0}$', fontsize=13)
...
plt.savefig("fabric_anisotropy.png", dpi=350)
plt.show()
